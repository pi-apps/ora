                    ...
                    <div className={`header__container ${cls} `}>
                        {isSearch ? (
                            ...
                            <div className="header__top">
                                <div>
                                    <Link to="/">
                                        <img src="/icons/wideLogo.png" alt="" width="180px" />
                                    </Link>
                                </div>
                                <div>
                                    {currentUser.currentUser ? (
                                                            ...
                                                            >
                                                                <div div className="header__dropdown-img">
                                                                    <img
                                                                        src={
                                                                            currentUser.currentUser.avatar
                                                                                ? `https://${currentUser.currentUser.avatar.slice(
                                                                                      7
                                                                                  )}`
                                                                                : "/icons/avatar.png"
                                                                        }
                                        ...
                                        <ul className="header__menu-top">
                                            ...
                                            <li>
                                                <Link to="/login">
                                                    <button className="header__button">{t("login")}</button>
                                                </Link>
                                            </li>
                                        </ul>
                                    )}
                        ...
                        <div className="header__menu">
                            <div className="header__cate" onClick={handleShow}>
                                <span className="header__title no-wrap">{t("following")}</span>
                                    ...
                                    <div className="header__cate-menu">
                                        {currentUser.currentUser ? (
                                            currentUser.currentUser.category.length !== 0 ? (
                                                ...
                                                <Link to="/category">
                                                    <div className="header__cate-link">
                                                        <span className="header__cate-text">{t("nothing")}</span>
                                                    </div>
                                                </Link>
                                            )
                                        ) : (
